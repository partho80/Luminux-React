...
function BlogDetailsAll() {
  return (
      <div>
          <section id="blog-details-page" className="section-padding blog-details-page">
    <div className="blog-section">
      <div className="container">
        <div className="row">
          <div className="col-lg-8 col-md-12">
            {/* <!-- Search Start --> */}
            <div className="product-search mb-3 mobile-show">
            ...
            <div className="blog-wrapper">
              <div className="single-blog mb-5">
                ...
                <div className="bc-comment d-flex mt-3">
                  <a href="#" className="text-custom me-4"><span><i className="fas fa-user"></i></span>Elex Janto </a>
                  <p className="text-custom me-4"><span><i className="fas fa-calendar-week"></i></span> 01 Feb 2022</p>
                ...
                <div className="about-author">
                  <img className="author-img me-4" src="assets/img/author.jpg" alt=""/>
                  ...
                  <div className="comment-wrapper">
                    <div className="single-comment">
                      <div className="comment-content">
                        <div className="writter-img-box me-4">
                ...
                <section id="post" className="">
                  ...
                  <div className="post-section">
                    <form id="post-form" className="post-form">
                      ...
                      <button type="submit" className="btn btn-custom btn-custom-primary">Submit</button>
                    </form>
                  </div>
                </section>
                {/* <!-- Post Section End --> */}
            ...
            <div className="recent-post-wrapper mb-5">
              ...
              <ul className="recent-post-collection">
                <li className="d-flex align-items-center mb-3">
                  <img src="assets/img/blog-1.jpg" alt="" className="rp-sm-img me-3"/>
                ...
                <li className="d-flex align-items-center mb-3">
                  <img src="assets/img/blog-2.jpg" alt="" className="rp-sm-img me-3"/>
                  <div className="rp-text d-inline-block">
                ...
                <li className="d-flex align-items-center mb-3">
                  <img src="assets/img/blog-4.jpg" alt="" className="rp-sm-img me-3"/>
                  <div className="rp-text d-inline-block">
